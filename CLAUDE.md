...
5. **Git protocol.** Conventional Commits, one concern per commit. **Never commit secrets or
   ...
   **Exception, decided 2026-08-25:** Jeffrey de la Cruz may merge his own pull requests without
   waiting for another teammate's approval, in recognition of his role helping collaborators
   finish their products — but a PR is still required for every change; this exception is
   ...
   GitHub repository ruleset (bypass actor: `Jeffreys-World`), layered alongside the existing
   branch protection rather than replacing it — force-push/deletion blocks, conversation
